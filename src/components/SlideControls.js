...
export const SlideControls = () => {
    ...
    return html`
        <nav id="slide_controls">
            <button className="changeslide prev" title="Previous slide" onClick=${go_previous_slide}><span></span></button>
            <button className="changeslide next" title="Next slide" onClick=${go_next_slide}><span></span></button>
        </nav>
    `
}
